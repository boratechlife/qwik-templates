                    ...
                    <div class="bt685 flex  flex-col">
                      <div class="bt686 flex z-[3] overflow-auto flex-col overscroll-contain scroll-touch">
                        ...
                        >
                          ...
                          {/* TABS */}
                          <div
                            class="bt8525 bt8520 bt8411 bt8413 flex-col text-[rgba(77,77,77,0.5)] w-full flex bg-[#f9fafb] font-semibold border-transparent"
                            data-editor-id="betslipTabs"
                          >
                            <div class="bt8526 w-full flex-1 flex">
                              <div class="bt8527 bt8521 bt8522 flex-1  m-0 text-xs w-full text-center transition-colors duration-500 leading-4 pt-3 pb-3 text-[rgba(77,77,77,1)] cursor-default border-b border-[#0B4DF7]">
                                Single
                              </div>
                              <div class="bt8527 bt8521 flex-1  m-0 text-xs w-full text-center transition-colors duration-500 leading-4 pt-3 pb-3 text-[rgba(77,77,77,1)] cursor-default border-b border-transparent">
                                Combo
                              </div>
                              <div class="bt8527 bt8521 flex-1  m-0 text-xs w-full text-center transition-colors duration-500 leading-4 pt-3 pb-3 text-[rgba(77,77,77,1)] cursor-default border-b border-transparent">
                                System
                            ...
                            <div
                              class="bt8528 bt8524 h-[2px] max-w-[33.333%] bg-[#0B4DF7] transition-transform transition-width duration-300 ease-in-out"
                              data-editor-id="tabsUnderline"
                              style="width: 106.656px; transform: translateX(0px);"
                            ></div>
                          </div>
                          ...
                          <div class=""></div>
                          <div class="bt717 text-[#4d4d4d]  pt-[24px] hidden px-[16px] border-t border-t-[rgba(77,77,77,0.1)] box-border flex-col min-w-full opacity-100 pointer-events-auto  bt694 bt695 bt697">
